...
// ═══════════════════ ENTRY STATUS PLOTS (After Entry Logic) ═══════════════════
...
plotchar(strategy.position_size != 0, title="📈 POSITION SIZE", char='📈', location=location.top, color=strategy.position_size > 0 ? color.green : color.red, size=size.small)
